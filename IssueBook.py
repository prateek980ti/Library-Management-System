...
def issue():
    ...
    issueSql = "insert into "+issueTable+" values ('"+bid+"','"+issueto+"','"+phonenumber+"','"+address+"','"+date+"')"
...
def issueBook(): 
    ...
    Canvas1 = Canvas(root)
    Canvas1.config(bg="#eba1ff")
    Canvas1.pack(expand=True,fill=BOTH)

    headingFrame1 = Frame(root,bg="#FFBB00",bd=5)
    headingFrame1.place(relx=0.25,rely=0.1,relwidth=0.5,relheight=0.13)
        
    headingLabel = Label(headingFrame1, text="Issue Book", bg='black', fg='white', font=('Bernard MT Condensed',15))
    ...
    inf4.place(relx=0.3,rely=0.65, relwidth=0.62)

    #DATEISSUED
    lb5 = Label(labelFrame,text="DATE(dd/mm/yy) : ", bg='black', fg='white')
    lb5.place(relx=0.05,rely=0.8)

    inf5 = Entry(labelFrame)
    inf5.place(relx=0.3,rely=0.8, relwidth=0.62)
